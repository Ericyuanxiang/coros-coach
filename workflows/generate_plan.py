    ...
    if ai_decision is None:
        return {
            ...
            "fill": {
                ...
                "daily_plan": {
                    "type": "list[7 days]",
                    "format": '{"date": "YYYYMMDD", "type": "rest|recovery|easy|quality|long", "tl_pct": 10-40}',
                    "example": [{"date": "20260601", "type": "recovery", "tl_pct": 10},
                                {"date": "20260602", "type": "easy", "tl_pct": 15},
                                {"date": "20260603", "type": "quality", "tl_pct": 20},
                                {"date": "20260604", "type": "easy", "tl_pct": 15},
                                {"date": "20260605", "type": "easy", "tl_pct": 10},
                                {"date": "20260606", "type": "long", "tl_pct": 30},
                                {"date": "20260607", "type": "rest", "tl_pct": 0}],
                    "hint": "tl_pct 是周 TL 的百分比(0-45), 不是绝对值. rest=0, recovery 5-12, easy 10-20, quality 15-30, long 20-45. 7 天不必精确 100%, Phase 2 会校验.",
